...
public class EmployeeRegisterationPage {
	...
	private Employe_LoginPage emplogin;
	...
	public Employe_LoginPage getEmplogin() {
		return emplogin;
	}

	public void setEmplogin(Employe_LoginPage emplogin) {
	...
	public EmployeeRegisterationPage(int emp_id, String emp_FullName, String emp_Address, String emp_Gender,
			...
			String emp_Password, Employe_LoginPage emplogin) {
		super();
		Emp_id = emp_id;
		Emp_FullName = emp_FullName;
		Emp_Address = emp_Address;
